...
class Config:
    ...
    datafile: str = 'data_thermoelastic/b-i=10-1,16-refined.csv'
    input_dim: int = 2
    output_dim: int = 1
...
result_FE = pd.read_csv("data_thermoelastic/b-i=10-1,16-refined.csv")
# result_FE = pd.read_csv(cfg.datafile)
...
# plt.savefig('data_thermoelastic/data/disp')
...
# plt.savefig('data_thermoelastic/data/stress')
...
# plt.savefig('data_thermoelastic/data/deform')
...
# plt.savefig('data_thermoelastic/data/temp')
